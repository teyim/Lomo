...
export const addAssetCategoryService = async (
    name: string,
    ...
    try {
        ...
        const background = await addAssetCategory(
            name,
        );
        return background;
    } catch (error) {
...
export const updateAssetCategoryService = async (id: string, newName: string) => {
    try {
